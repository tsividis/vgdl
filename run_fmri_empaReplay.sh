...
do
    ...
    do
        ...
        do
            ...
            out=`mongo --host holy2a05207.rc.fas.harvard.edu heroku_7lzprs54 --eval "db.plays.count({'subj_id': '${1}', 'run_id': ${run}, 'block_id': ${block}, 'instance_id': ${instance}, 'game_name': '${2}'})"`
            ...
            do
                ...
                #out=`mongo --host holy2a05207.rc.fas.harvard.edu heroku_7lzprs54 --eval "db.regressors.count({'subj_id': '${1}', 'game_name': '${2}'})"`
                #out=`mongo --host holy2a05207.rc.fas.harvard.edu heroku_7lzprs54 --eval "db.regressors_cannon_spriteEvery20.count({'subj_id': '${1}', 'game_name': '${2}'})"`
                out=`mongo --host holy2a05207.rc.fas.harvard.edu heroku_7lzprs54 --eval "db.regressors.count({'subj_id': '${1}', 'game_name': '${2}'})"`
