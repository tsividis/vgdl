...
for subj in ${subjects[*]}; do
    for game in ${games[*]}; do
        ...
        #
        sbatch_output=`sbatch -p fasse --mem 50001 -t 2-15:20 -o ${outfileprefix}_%j.out -e ${outfileprefix}_%j.err --wrap="./run_fmri_agentReplay.sh ${agent} ${subj} ${game}"`
