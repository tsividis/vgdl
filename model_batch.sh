...
#SBATCH --array=0-1%30
#SBATCH --output=slurm_logs/hyperopt_optimized_planner/array_%A_%a.out
#SBATCH --time=360
...
if [ ! -d "slurm_logs/hyperopt_optimized_planner" ]; then
    mkdir "slurm_logs/hyperopt_optimized_planner"
fi
