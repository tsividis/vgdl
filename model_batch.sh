...
ROOT="/om2/user/belledon/git/vgdl"
...
N_GAMES=10
N_PARAMS=3
GAME_NAME=$(($SLURM_ARRAY_TASK_ID % $N_GAMES))
...
singularity exec  -B "/$BASE:/$BASE" $CONT python -m vgdl.load_games --game_name $GAME_NAME --hyperparameter_index $HYPER_IDX
