...
class Theory(object):
	...
	def ruleSimilarity(self, cx, cy):
		...
		cxSlot1 = [(r.interaction, r.slot2, r.preconditions) for r in hypotheses[0].interactionSet 
		if r.slot1==cx]
		cySlot1 = [(r.interaction, r.slot2, r.preconditions) for r in hypotheses[0].interactionSet 
		if r.slot1==cy]

		cxSlot2 = [(r.interaction, r.slot1, r.preconditions) for r in hypotheses[0].interactionSet 
		if r.slot2==cx]
		cySlot2 = [(r.interaction, r.slot1, r.preconditions) for r in hypotheses[0].interactionSet 
		if r.slot2==cy]
...
{'agentAction': None, 'agentState': {'trap': 1}, 'effectList': [('bounceForward', 'RED', 'ORANGE')]}, 
...
n1=VGDLTree.members["<class 'core.VGDLSprite'>"].children[4]
n2=VGDLTree.members["<class 'core.VGDLSprite'>"].children[4].children[0]

# hypotheses[0].similarity('c1', 'c2', g.VGDLTree, 1)
h=hypotheses[0]
# t=hypotheses[0]
# n1=t.classes['c1'][0].vgdlType
# n2=t.classes['c2'][0].vgdlType
#  g.VGDLTree.distance(n1,n2)
