...
BasicGame frame_rate=30
    SpriteSet        
        ...
        poison1 > ResourcePack color=GOLD
        poison2 > ResourcePack color=RED
        box1 > ResourcePack color=ORANGE
        box2 > ResourcePack color=LIGHTBLUE
        box3 > ResourcePack color=PINK
    ...
    InteractionSet
        ...
        box3 poison1 > undoAll
        box1 poison2 > undoAll
        box2 poison2 > undoAll
        box3 poison2 > undoAll
