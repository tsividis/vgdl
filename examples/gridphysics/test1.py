...
BasicGame frame_rate=30
    SpriteSet        
        ...
        amidarWall > Passive 
            aWall1 > setMembership: [A]
            aWall2 > setMembership: [A,B]
        amidarFence > Passive
            aFence1 > if count(A) > 10....

        walker > ErraticMissile color=RED speed=0.2
    ...
    LevelMapping
        ...
        A > avatar
    RelationSet
        square > logicalObject On
    InteractionSet
        avatar wall > stepBack  
        box avatar > killSprite  
        missile wall > reverseDirection
        walker wall > reverseDirection
