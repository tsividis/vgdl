...
BasicGame
	SpriteSet
		c9 > RandomNPC color=GREEN speed=0.5 cooldown=10
		c8 > RandomNPC color=LIGHTORANGE speed=0.5 cooldown=10
		avatar > MovingAvatar color=DARKBLUE
		c3 > RandomNPC color=LIGHTBLUE speed=0.5 cooldown=10
		...
		c10 > RandomNPC color=ORANGE speed=0.5 cooldown=10
		c7 > RandomNPC color=LIGHTGREEN speed=0.5 cooldown=10
		c6 > RandomNPC color=DARKGRAY speed=0.5 cooldown=10
		c5 > RandomNPC color=BROWN speed=0.3 cooldown=1
		c4 > RandomNPC color=BLUE speed=0.5 cooldown=10
	InteractionSet
