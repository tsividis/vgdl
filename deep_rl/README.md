...
## Known Issues
`pygame.init()` seems to be initializing something audio related in the background, which might give warnings based on permissions on OpenMind. [Here](https://stackoverflow.com/questions/31847497/pygame-tries-to-use-alsa?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa)Here is a description of the warning. This doesn't affect performance, but might make viewing your results a little harder depending on if the warnings get recorded in your logs. 
