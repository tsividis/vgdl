...
[ "dqn",      "vgdl",      "portals",                  "dqn-vgdl",      "sequential"],  # 0
[ "a3c",      "vgdl",      "portals",                  "a3c-cnn-dis",  "none"],  # 1
]
...
class Params(object):   # NOTE: shared across all modules
    def __init__(self):
        ...
        # training signature
        self.machine     = "openmind"    # "machine_id"
        self.timestamp   = "180510"      # "yymmdd##"
...
class EnvParams(Params):    # settings for simulation environment
    def __init__(self):
        ...
        elif self.env_type == "vgdl":
            self.hei_state = 42
            self.wid_state = 42
            self.preprocess_mode = 4
        else:
            assert False, "env_type must be: gym | atari-ram | atari | lab | vgdl"
    ...
    def __init__(self):
        ...
        if self.agent_type == "dqn" and self.env_type == "gym":
            ...
            self.train_interval      = 1
             ...
             self.agent_type == "dqn" and self.env_type == "vgdl":
            ...
            self.learn_start         = 500000    # start update params after this many steps
            self.batch_size          = 32
            self.valid_size          = 500
            self.eps_start           = 1
            self.eps_end             = 0.1
