...
for subj in ${subjects[*]}; do
        ...
        # send the job to NCF
        #
        sbatch_output=`sbatch -p fasse --mem 20001 -t 1-15:20 -o ${outfileprefix}_%j.out -e ${outfileprefix}_%j.err --wrap="source activate pedro; python fmri_playsPostproc.py ${subj}"`
        # for local testing
