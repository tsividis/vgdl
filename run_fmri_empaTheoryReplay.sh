...
do
    ...
    do
        ...
        do
            ...
            #out=`mongo --host holy7c22107.rc.fas.harvard.edu heroku_7lzprs54 --eval "db.plays.count({'subj_id': '${1}', 'run_id': ${run}, 'block_id': ${block}, 'instance_id': ${instance}, 'game_name': '${2}'})"` # ncf
            out=`mongo --host holy7c22107.rc.fas.harvard.edu heroku_7lzprs54 --eval "db.plays.count({'subj_id': '${1}', 'run_id': ${run}, 'block_id': ${block}, 'instance_id': ${instance}, 'game_name': '${2}'})"` # cannon
            ...
            do
                ...
                out=`mongo --host holy7c22107.rc.fas.harvard.edu heroku_7lzprs54 --eval "db.plans.count({'subj_id': '${1}', 'game_name': '${2}'})"`
