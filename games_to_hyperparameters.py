...
# 'jaws', 'variant_jaws_1', 'variant_jaws_2',#31
...
game_names = ['variant_plaqueattack_1']
# game_names = ['variant_expt_helper_2']
# game_names = ['watergame', 'variant_watergame_1', 'variant_watergame_2', 'boulderdash', 'variant_boulderdash_1', 'variant_boulderdash_2']
...
# game_names = ['boulderdash', 'variant_boulderdash_1', 'variant_boulderdash_2']
