...
# 'bait', 'variant_bait_1', 'variant_bait_2', #10-12
...
# 'chase', 'variant_chase_1', 'variant_chase_2', 'variant_chase_3', #21-24
# 'closing_gates', 'variant_closing_gates_1',
# 'corridor','variant_corridor_1', 
# 'expt_antagonist', 'variant_expt_antagonist_1','variant_expt_antagonist_2', #29-
# 'expt_ee', 'variant_expt_ee_1', 'variant_expt_ee_2', 'variant_expt_ee_3', 
# 'expt_helper', 'variant_expt_helper_1', 'variant_expt_helper_2', 
# 'expt_preconditions', 'variant_expt_preconditions_1', 'variant_expt_preconditions_2',#41
...
# 'jaws', 'variant_jaws_1', 'variant_jaws_2',#52-54
# 'lemmings', 'variant_lemmings_1',  'variant_lemmings_2', 'variant_lemmings_3',
# 'missilecommand', 'variant_missilecommand_1', 'variant_missilecommand_2', 'variant_missilecommand_3', 'variant_missilecommand_4',#62-63
# 'myAliens', 'variant_myAliens_1', 'variant_myAliens_2',
# 'plaqueattack', 'variant_plaqueattack_1', 'variant_plaqueattack_2', 'variant_plaqueattack_3',#70
...
# 'sokoban', 'variant_sokoban_1', 'variant_sokoban_2',#80-82
