...
for k in game_names:
    if k not in ['bait', 'jaws', 'myAliens', 'shipwreck', 'plaqueattack', 'wildgunman']+['infection', 'lemmings', 'modality', 'plants', 'tercio', 'waves']: #[need a little debugging] [need much looking into]
        mapping[k] = [0,2]
