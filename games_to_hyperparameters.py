...
game_names = ['variant_aliens_1', 'variant_aliens_2',
'variant_avoidgeorge_1', 'variant_avoidgeorge_4',
'variant_bait_1', 'variant_bait_2',
'variant_boulderdash_1', 'variant_boulderdash_2',
'closing_gates', 'variant_closing_gates_1',
'lemmings', 'variant_lemmings_1',  'variant_lemmings_2', 'variant_lemmings_3',
'variant_missilecommand_1', 'variant_missilecommand_3', 'variant_missilecommand_4',
 'myAliens', 'variant_myAliens_1',
'survivezombies',
'zelda','variant_zelda_1', 'variant_zelda_3',
'expt_helper', 'variant_expt_helper_1', 'variant_expt_helper_2', 
'expt_preconditions', 'variant_expt_preconditions_2',
